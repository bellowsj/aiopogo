    ...
    async def user_login(self, username=None, password=None):
        ...
        try:
            ...
            async with ClientSession(
                ...
                async with session.get('https://sso.pokemon.com/sso/oauth2.0/authorize',
                                       params={'client_id': 'mobile-app_pokemon-go',
                                               'redirect_uri': 'https://www.nianticlabs.com/pokemongo/error',
                                               'locale': self.locale}, timeout=8.0, proxy=self.proxy,
                    ...
                    async with session.get('https://sso.pokemon.com/sso/logout', params={
                        'service': 'https%3A%2F%2Fsso.pokemon.com%2Fsso%2Foauth2.0%2FcallbackAuthorize'}, timeout=8.0,
                                           proxy=self.proxy, proxy_auth=self.proxy_auth, allow_redirects=False) as _:
                        pass
                    ...
                    async with session.get('https://sso.pokemon.com/sso/login', params={
                        ...
                        'locale': self.locale}, timeout=8.0, proxy=self.proxy, proxy_auth=self.proxy_auth) as _:
                        pass
